...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   ...
   <!-- ICON GO TO -->
    ...
    <title> Login - Go To | Ag�ncia de Viagens </title>
...
<body>
    ...
    <div class="container-fluid mt-3">
        ...
        <header class="row">
            ...
            <div class="col-sm-6 text-center">
                ...
                <p class="small"> A Go To Viagens te leva aonde voc� quer chegar! </p>
    ...
    <footer class="container-fluid bg-light">
        ...
        <div class="row mt-4 mb-3">
            <div class="col-12 text-center"> &copy 2022 - Go To Ag�ncia de Viagens </div>
        </div>
